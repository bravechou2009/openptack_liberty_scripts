...
openstack endpoint create --region RegionOne servicevm public http://controller:8888/
openstack endpoint create --region RegionOne servicevm internal http://controller:8888/
openstack endpoint create --region RegionOne servicevm admin http://controller:8888/
fi
